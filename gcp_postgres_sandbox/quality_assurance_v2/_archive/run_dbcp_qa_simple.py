#!/usr/bin/env python3
"""
Run QA specifically for dbcp database - Windows compatible version.
"""
...
def run_dbcp_qa():
    """Run QA checks for dbcp database."""
    ...
    try:
        ...
        try:
            ...
            qa_results.append(QAResult(
                ...
                status="ERROR",
                risk_level="CRITICAL",
                message=f"Database connection error: {str(e)[:100]}",
                details={"database": "dbcp"}
            ))
        
        # Test key tables existence with simple queries
        key_tables = [
            'FE_DMV_ALL', 'FE_MOMENTUM_SIGNALS', 'crypto_listings_latest_1000'
        ]
